/**  版本信息模板在安装目录下，可自行修改。
* ViewInstructorPeccancy.cs
*
* 功 能： N/A
* 类 名： ViewInstructorPeccancy
*
* Ver    变更日期             负责人  变更内容
* ───────────────────────────────────
...
{
	/// <summary>
	/// ViewInstructorPeccancy:实体类(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public partial class ViewInstructorPeccancy
	{
		public ViewInstructorPeccancy()
		{}
		#region Model
		private int _id;
