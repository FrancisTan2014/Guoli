                ...
                },
                {
                    ...
                    */
                    fnCreatedCell: function (nTd, sData, oData, iRow, iCol) {
                        ...
                        $(nTd).empty().append('<a role="button" tabindex="0" class="edit text-primary text-strong text-sm mr-10" href="http://192.168.0.108:8080/#/temptake-prev?id={0}">查看详情</a>'.format(sData));
                    }
                }]
            });
        }
