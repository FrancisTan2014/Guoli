    ...
    <section>
        ...
        <el-table :data="data" highlight-current-row v-loading="isLoading" id="table">
            ...
            <el-table-column prop="ViceDriverName"
                                ...
                                ></el-table-column>
            <el-table-column prop="ViceDriverScore"
                                label="得分"


                                ></el-table-column>
            <el-table-column prop="Problems"
                                label="存在的问题"
            ...
            load: function () {
                ...
                server.post(this.apiUrl, { json: JSON.stringify(o) }).then(res => {
                    ...
                    if (data) {
						...
						AcceptDateFormatter: function(row) { let d = moment(row.AcceptDate);
if (d.year() === 1900) {
	return '';
}
