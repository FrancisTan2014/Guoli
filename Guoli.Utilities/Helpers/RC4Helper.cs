...
namespace Guoli.Utilities.Helpers
{
    ...
    public class CryptoBase
    {
        ...
        public EncoderMode Mode = EncoderMode.HexEncoder;
        ...
        public string Decrypt(String data, String pass, CryptoBase.EncoderMode em)
        {
            ...
            if (em == EncoderMode.Base64Encoder)
                ...
                return Encode.GetString(DecryptEx(strToToHexByte(data), pass));
            //return Encode.GetString(DecryptEx(Encode.GetBytes(data), pass));
        }
    ...
    public class Rc4Helper : CryptoBase
    {
        public static Rc4Helper RC4 = new Rc4Helper();
        /// <summary>
        /// 加密解密算法实现
        /// </summary>
